# --- text ---
text-craft-choose-title = <b>Выбор ремесла</b>
text-craft-choose-cooldown = Сменить ремесло можно через <b>{ $when }</b>
text-craft-no_professions = Нет доступных ремесел. Обратитесь к <a href="https://t.me/megatocha">создателю.</a>
text-craft-status-selected = <b>Выбрано</b>
text-craft-status-available = Доступно
text-craft-status-locked = Недоступно
text-craft-status-required_level = Требуется ступень
text-craft-selected-success = <b>{ $user_name }</b> ремесло себе избрал: <b>{ $profession_name }!</b>
...
callback-craft-already_selected = Ты уж сие ремесло избрал! Аль сменить хочешь, то другое избери.
