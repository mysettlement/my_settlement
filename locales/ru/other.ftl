...
text-other-private-greeting = <b>Здрав будь!</b> Я вестник для игры в <b>Поселения</b>.
    Чтоб в сходку свою меня позвать, <b>на знак ниже ткни:</b>
text-other-cancel = Отменено.

# --- text - bot events ---
text-other-bot-left = <b>Я покинул стены поселения «{ $chat_title }»...</b>
    Буду признателен, если расскажешь, что пошло не так.
    Это поможет мне стать лучше для других правителей.
text-other-bot-added = <b>Добро пожаловать в игру «Поселения»!</b>
...
# --- text - help ---
text-other-help = <b>Моё Поселение!</b> — текстовая MMORPG о жизни общины.
...
text-other-promo-bad_format = Неверный формат команды.
