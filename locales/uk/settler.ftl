...
text-settler-profile-full-level = Сходинка
text-settler-profile-full-exp = Досвід
text-settler-profile-full-rank = Назва
...
text-settler-error-not_found = Сталася біда, твоїх новин не знайдено. Зачекай трохи, потім спробуй ще раз.
# --- text - cosmetics ---
...
text-settler-overtime-hint = Якщо тобі мало добра, можеш взяти <b>страду</b>. З кожною страдою робота стає важчою, мудрості набереш менше, але грошей отримаєш стільки ж. Якщо <b>не встигнеш виконати роботу</b> до нового дня ({ $reset_countdown }), на тебе накладуть <b>прокляття</b>.
text-settler-overtime-status-active =
    Статус кампанії: <b>Активна</b>
    Скільки коштів зібрано: { $overtime_count } (<b>{ $reset_countdown }</b> до нової стради)
    📄 Міра: <b>{ $quote }/{ $target_quote }</b>
text-settler-overtime-status-need_quota = Страду можна брати, але тільки після виконання основної 📄 умови!
...
text-settler-overtime-taken =
    <b>Замовлення прийнято!</b> (📄 0/{ $new_quote })
...
text-settler-inventory-hint = Ресурси можуть добувати різні фахівці, а також їх можна отримати як нагороду за виконання завдань.
# --- button ---
